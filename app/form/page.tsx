  ...
  const slides = [
    ...
    <div key="diagnosis" className="space-y-4 bg-[#4400ff]/10 p-6 rounded-lg shadow-md border border-[#4400ff]/20 flex flex-col">
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            <TableCell className="text-[#4400ff]/80">Médecin généraliste</TableCell>
            <TableCell>
              <a href="https://www.doctolib.fr/medecin-generaliste" target="_blank" rel="noopener noreferrer" className="text-[#4400ff] hover:text-[#4400ff] underline font-medium hover:font-bold px-4 leading-[1.2] tracking-wide hover:tracking-normal transition-all duration-200">
                Rechercher sur Doctolib
              </a>
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell className="text-[#4400ff]/80">Dermatologue</TableCell>
            <TableCell>
              <a href="https://www.doctolib.fr/dermatologue" target="_blank" rel="noopener noreferrer" className="text-[#4400ff] hover:text-[#4400ff] underline font-medium hover:font-bold px-4 leading-[1.2] tracking-wide hover:tracking-normal transition-all duration-200">
                Rechercher sur Doctolib
              </a>
            </TableCell>
          </TableRow>
