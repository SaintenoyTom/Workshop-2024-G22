...
export default function FormulaireCcontact() {
  ...
  const checkFormData = () => {
    ...
    email.error =
      !email.value.length ||
      !email.value.match(
        /[a-z0-9]+(?:\.[a-z0-9]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/g
      );
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <DialogFooter>
            <Button
              ...
              className="bg-[#4400ff] hover:bg-[#3300cc] text-white"
            >
              Fermer
            </Button>
          </DialogFooter>
