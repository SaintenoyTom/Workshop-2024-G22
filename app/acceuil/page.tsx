...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center bg-[#80ff00]/50">
        <Link className="flex items-center justify-center" href="#">
          <HeartPulse className="h-6 w-6" />
          <span className="sr-only">Conseil Médical</span>
        </Link>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none text-[#7f00ff]">
                  Votre santé, notre priorité
                </h1>
                <p className="mx-auto max-w-[700px] text-[#7f00ff]/50 md:text-xl">
                  Des conseils médicaux personnalisés pour vous aider à prendre les meilleures décisions pour votre santé.
                </p>
              </div>
              <div>
                <Button>Obtenir un conseil</Button>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="mt-4 font-semibold">Marie D.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="mt-4 font-semibold">Pierre L.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="mt-4 font-semibold">Sophie M.</p>
                </CardContent>
              </Card>
            </div>
          </div>
